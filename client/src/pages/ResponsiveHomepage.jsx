...
=======
  ...
  const calculateRiskLevel = () => {
    if (!weatherData) return { level: 'Low', reason: 'Loading...', color: 'success' }
    return APIService.calculateRiskLevel(weatherData)
  }
...
=======
  ...
  if (currentPage === 'quest') {
    return <QuestDemoPage onBack={handleBackToHome} currentLanguage={currentLanguage} />
  }

  if (currentPage === 'community') {
    return <CommunityDemoPage onBack={handleBackToHome} currentLanguage={currentLanguage} />
  }

  if (currentPage === 'help') {
    return <HelpDemoPage onBack={handleBackToHome} currentLanguage={currentLanguage} />
  }

  if (currentPage === 'notifications') {
    return <NotificationsDemoPage onBack={handleBackToHome} currentLanguage={currentLanguage} />
  }

  if (currentPage === 'privacy') {
    return <PrivacyDemoPage onBack={handleBackToHome} currentLanguage={currentLanguage} />
  }
...
=======
                <p className="text-xs text-slate-500">Smart Farming Assistant</p>
>>>>>>> ce17b631e47435b0fbcc27a198d9eafa8e5cd39b
              </div>
            </div>
...
=======
              ...
              <div className="flex items-center space-x-2">
                ...
                <select 
                  ...
                  className="text-sm border border-slate-200 rounded-lg px-2 py-1 bg-white text-slate-700 focus:outline-none focus:ring-2 focus:ring-emerald-500"
                >
...
=======
                    <TranslatedText>Welcome back, {user?.name || 'Farmer'}!</TranslatedText>
>>>>>>> ce17b631e47435b0fbcc27a198d9eafa8e5cd39b
                  ) : (
...
=======
                    <TranslatedText>Ready to continue your farming journey?</TranslatedText>
                  ) : (
                    <TranslatedText>Your smart farming assistant - Get started with free features or sign up for personalized tracking</TranslatedText>
>>>>>>> ce17b631e47435b0fbcc27a198d9eafa8e5cd39b
                  )}
                </p>
...
=======
                          <span><TranslatedText>Ask</TranslatedText></span>
>>>>>>> ce17b631e47435b0fbcc27a198d9eafa8e5cd39b
                        </>
                      )}
                    </button>
...
=======
                          <TranslatedText>Guest Mode - Limited Features</TranslatedText>
                        </h3>
                        <p className="text-sm text-amber-700 mt-1">
                          <TranslatedText>You can browse and use basic features. Sign up to track progress, earn points, and access the full community.</TranslatedText>
>>>>>>> ce17b631e47435b0fbcc27a198d9eafa8e5cd39b
                        </p>
                        <button
                          onClick={() => setShowAuthModal(true)}
...
=======
                          <TranslatedText>Sign up for full access →</TranslatedText>
>>>>>>> ce17b631e47435b0fbcc27a198d9eafa8e5cd39b
                        </button>
                      </div>
                    </div>
...
=======
            <div id="quick-actions" className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 lg:p-8 shadow-lg border border-white/50">
              <h2 className="text-2xl font-semibold text-slate-800 mb-6">
                <TranslatedText>Quick Actions</TranslatedText>
              </h2>
                      ...
                      <p className="text-sm text-slate-600">
                        <TranslatedText>
                          {isDisabled
                            ...
                            : action.guestDescription}
=======
                      <div className={`w-12 h-12 rounded-xl ${action.color.replace('border-', 'bg-').replace('text-', 'text-')} flex items-center justify-center mb-4 group-hover:scale-110 transition-transform`}>
                        <Icon className="w-6 h-6" />
                      </div>
                      ...
                      <p className="text-sm text-slate-600">
                        <TranslatedText>
                          {isDisabled ? action.guestDescription : action.guestDescription}
>>>>>>> ce17b631e47435b0fbcc27a198d9eafa8e5cd39b
                        </TranslatedText>
                      </p>
...
=======
                ...
                <div className="space-y-4">
                  {adviceCards.map((advice) => (
                    <div key={advice.id} className="bg-gradient-to-r from-emerald-50 to-teal-50 rounded-xl p-6 border border-emerald-100">
                      <h3 className="text-lg font-semibold text-slate-800 mb-2">
                        {advice.title}
                      </h3>
...
=======
                    <div className="text-3xl font-bold text-slate-800">{weatherData.current.temp}°C</div>
                    <div className="text-slate-600 text-sm">
...
=======
                  <div key={index} className="flex items-center justify-between text-sm">
                    <span className="text-slate-600">{day.d}</span>
                    <div className="flex items-center space-x-2">
                      <span className="text-slate-800">{day.t_min}°-{day.t_max}°</span>
                      {day.icon === 'sun' && <Sun className="w-4 h-4 text-amber-500" />}
                      {day.icon === 'cloud' && <Cloud className="w-4 h-4 text-slate-500" />}
                      {day.icon === 'rain' && <Droplets className="w-4 h-4 text-blue-500" />}
>>>>>>> ce17b631e47435b0fbcc27a198d9eafa8e5cd39b
                    </div>
                  </div>
                ))}
...
=======
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <span className="text-slate-600"><TranslatedText>Level</TranslatedText></span>
                    <span className="text-lg font-bold text-emerald-600">{user?.level || 1}</span>
                  </div>
                  
                  <div className="flex items-center justify-between">
                    <span className="text-slate-600"><TranslatedText>Points</TranslatedText></span>
                    <span className="text-lg font-bold text-blue-600">{user?.totalPoints || 0}</span>
                  </div>
                  
                  <div className="flex items-center justify-between">
                    <span className="text-slate-600"><TranslatedText>Quests</TranslatedText></span>
                    <span className="text-lg font-bold text-purple-600">{user?.completedQuests || 0}</span>
                  </div>
                  
                  <div className="pt-3 border-t border-slate-200">
                    <div className="flex items-center justify-between mb-2">
                      <span className="text-slate-600"><TranslatedText>Sustainability Score</TranslatedText></span>
                      <span className="text-lg font-bold text-emerald-600">{user?.sustainabilityScore || 0}%</span>
>>>>>>> ce17b631e47435b0fbcc27a198d9eafa8e5cd39b
                    </div>
...
=======
                  <TranslatedText>Track your progress, earn rewards, and connect with fellow farmers.</TranslatedText>
                </p>
                
                <div className="space-y-2">
                  <div className="flex items-center space-x-2 text-sm text-emerald-100">
                    <CheckCircle className="w-4 h-4" />
                    <span><TranslatedText>Personal progress tracking</TranslatedText></span>
                  </div>
                  <div className="flex items-center space-x-2 text-sm text-emerald-100">
                    <CheckCircle className="w-4 h-4" />
                    <span><TranslatedText>Earn points & badges</TranslatedText></span>
                  </div>
                  <div className="flex items-center space-x-2 text-sm text-emerald-100">
                    <CheckCircle className="w-4 h-4" />
                    <span><TranslatedText>Community features</TranslatedText></span>
                  </div>
                </div>
