  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        {submitMessage && (
          <div
            className={`m-4 p-4 rounded-lg flex items-center space-x-2 ${
              submitType === "success"
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-transparent"
                  placeholder={
                    currentLanguage === "hi" ? "9876543210" : "9876543210"
                  }
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-transparent"
                  placeholder={
                    currentLanguage === "hi" ? "शहर, राज्य" : "City, State"
                  }
                />
              </div>
            </div>
              ...
              <label className="flex items-center">
                <input
                  ...
                  onChange={(e) =>
                    setFormData((prev) => ({
                      ...prev,
                      wasAdviceHelpful: e.target.value,
                    }))
                  }
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-3">
              <TranslatedText>
                {currentLanguage === "hi"
                  ? "सलाह को 1 से 5 तक रेट करें"
                  : "Rate the advice on a scale of 1 to 5"}
              </TranslatedText>
            </label>
            <StarRating
              rating={formData.adviceRating}
              onRatingChange={(rating) =>
                setFormData((prev) => ({ ...prev, adviceRating: rating }))
              }
            />
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-3">
              <TranslatedText>
                {currentLanguage === "hi"
                  ? "फसल की समस्या की फोटो अपलोड करें"
                  : "Upload a photo of the crop issue you're facing"}
              </TranslatedText>
            </label>
          ...
          <div>
            ...
            <div className="flex space-x-4 mb-4">
              ...
              <label className="flex items-center">
                ...
                />
                <TranslatedText>
                  {currentLanguage === "hi" ? "आंशिक रूप से" : "Partially"}
                </TranslatedText>
              </label>
            </div>
